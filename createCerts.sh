...
fabric-ca-client enroll --csr.names C=ES,ST=Madrid,L=Madrid,O=netflix.com -m admin -u http://admin:adminpw@ica.netflix:8054 

sleep 10

# Register admin identity and peer
fabric-ca-client register --id.name Admin@netflix.com --id.secret mysecret --id.type client --id.affiliation org1 -u http://ica.netflix:8054 

fabric-ca-client register --id.name peer0.netflix.com --id.secret mysecret --id.type peer --id.affiliation org1 -u http://ica.netflix:8054 
...
fabric-ca-client enroll --csr.names C=ES,ST=Madrid,L=Madrid,O=netflix.com -m Admin@netflix.com -u http://Admin@netflix.com:mysecret@ica.netflix:8054 
...
fabric-ca-client enroll --csr.names C=ES,ST=Madrid,L=Madrid,O=netflix.com -m peer0.netflix.com -u http://Admin@netflix.com:mysecret@ica.netflix:8054 
